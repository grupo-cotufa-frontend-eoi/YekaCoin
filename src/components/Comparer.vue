      ...
      <table class="table-responsive ">
        ...
        <tbody class="table-body table-body pb-2">
          <tr  class="table-content">
            ...
            <td class="flex justify-center items-center"><img class="logo" :src="leftCoin.iconUrl" alt="" /></td>
            <td class="text-table">{{ parseFloat(leftCoin.price).toFixed(2) }} $</td>
            <td class="text-table">{{ parseFloat(leftCoin.change).toFixed(2) }} %</td>
          </tr>
          <tr class="table-content">
            <td class="flex justify-center">
            ...
            <td class="flex justify-center items-center"><img class="logo" :src="rightCoin.iconUrl" alt="" /></td>
            <td class="text-table">{{ parseFloat(rightCoin.price).toFixed(2) }} $</td>
            <td class="text-table">{{ parseFloat(rightCoin.change).toFixed(2) }} %</td>
          </tr>
        </tbody>
      </table>
    </div>
